...
bcftools mpileup -Oz -f ${REF} ${INPUT_DIR}/merged_bam/${PREP1}_${PREP2}_merged.bam | bcftools call -mv -R ${INTERVALS} -f GQ -Oz -o ${INPUT_DIR}/bcf_call/${PREP1}_${PREP2}.vcf.gz
